...
import (
	...
	"github.com/zqddong/go-programming-tour-book/tour/internal/sql2struct"
	"log"
)
...
func init() {
	// go run main.go sql struct --username sail --password password --db dev --table blog_article
